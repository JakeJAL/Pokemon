...
def load_all_cards_data():
    ...
    if ALL_CARDS_DATA is None:
        try:
            cards_file_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "all_cards.json")
...
# Initialize store search - look for CSV in the data directory
csv_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "pokemon_cards_database.csv")
